...
public class personsIdDeleteTest {
    ...
    public void personsIdDelete_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "bootexample4" + File.separator + "RoostTest" + File.separator + "persons_idDeleteTest.csv"))) {  
