...
public class authorizationsPostTest {
  ...
  public void setUp() {
    ...
    String[] envVariableList = envData.getEnvVariableList(
        "src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator
            + "bootexample4" + File.separator + "RoostTest" + File.separator + "authorizationsPostTest.csv");
  ...
  public void authorizationsPost_Test() {
    ...
    List<Map<String, String>> envVarsCSV = csvData.loadFromCSVFile(
        "src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator
            + "bootexample4" + File.separator + "RoostTest" + File.separator + "authorizationsPostTest.csv");
    ...
    for (Map<String, String> row : envVarsCSV) {
      ...
      if (response.statusCode() == 201) {
        ...
        // MatcherAssert.assertThat(response.jsonPath().getString("name"),
        ...
        instanceOf(String.class));MatcherAssert.assertThat(
